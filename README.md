...
# NB: This was copied from CatapultSystems blog and the original blog can be found [here](https://www.catapultsystems.com/blogs/migrate-distribution-groups-from-exchange-on-premise-to-exchange-online/). I saved it here incase the blog goes down. 
